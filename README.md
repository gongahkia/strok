...
| `--mode luminance\|structure\|halfblock\|blocks\|octant` | Select renderer. |
| `--pipeline luminance\|structure\|halfblock\|blocks\|octant` | Select a render-graph preset; overrides config `pipeline`. |
