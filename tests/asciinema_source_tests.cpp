...
int main() {
  {
    ...
    const std::optional<contourtty::Frame> first = source.nextFrame();
    ...
    const std::optional<contourtty::Frame> second = source.nextFrame();
    ...
    source.restart();
    const std::optional<contourtty::Frame> restarted = source.nextFrame();
