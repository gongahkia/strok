...
int main() {
  {
    contourtty::CellBuffer cells(1, 3);
    cells.at(0, 0).glyph = U'|';
    cells.at(0, 1).glyph = U'|';
    cells.at(0, 2).glyph = U'|';
    contourtty::applyLineLigatures(&cells);
  ...
  {
    contourtty::CellBuffer cells(3, 1);
    cells.at(0, 0).glyph = U'-';
  ...
  {
    contourtty::CellBuffer cells(2, 2);
    cells.at(0, 0).glyph = U'|';
    cells.at(1, 0).glyph = U' ';
    cells.at(0, 1).glyph = U'+';
    cells.at(1, 1).glyph = U'-';
    cells.at(0, 1).fg = contourtty::Rgb{.r = 1, .g = 2, .b = 3};
    contourtty::applyLineLigatures(&cells);
