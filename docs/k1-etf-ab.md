...
ffmpeg -hide_banner -loglevel error -f lavfi -i "nullsrc=s=320x240:d=0.3:r=10,geq=lum='if(gt($expr,0),255,0)':cb='128':cr='128'" -frames:v 3 -pix_fmt yuv420p -y /tmp/contourtty-k1-wire-cube.mp4
```

Commands:

```sh
./build/ci/contourtty --mode structure --edge-threshold 0.02 --dog-sigma 0 --width 80 --height 30 --fps 1000 --color-mode mono --export /tmp/contourtty-k1-raw.ansi --log /tmp/contourtty-k1-raw.log /tmp/contourtty-k1-wire-cube.mp4
./build/ci/contourtty --mode structure --etf-iters 3 --edge-threshold 0.02 --dog-sigma 0 --width 80 --height 30 --fps 1000 --color-mode mono --export /tmp/contourtty-k1-etf.ansi --log /tmp/contourtty-k1-etf.log /tmp/contourtty-k1-wire-cube.mp4
```
