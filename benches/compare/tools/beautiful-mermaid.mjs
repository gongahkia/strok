...
const defaultOutDir = join(repoRoot, "benches/compare/results/beautiful-mermaid");

function usage() {
  return `Usage:
  node benches/compare/tools/beautiful-mermaid.mjs [--manifest FILE] [--out-dir DIR] [--allow-failures]
  node benches/compare/tools/beautiful-mermaid.mjs --input FILE [--input FILE...] [--out-dir DIR]
  node benches/compare/tools/beautiful-mermaid.mjs --input FILE --stdout
