...
- Flowchart classic shapes and Mermaid v11 named shapes render as the same text
  box geometry. `classDef`/`class` and edge stroke variants are parsed but do
  not currently change frame styling or line glyphs.
