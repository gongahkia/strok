...
const SNAPSHOT_NAMES: [&str; 4] = [
    "japanese_flowchart",
    "korean_flowchart",
    "simplified_chinese_flowchart",
    "traditional_chinese_flowchart",
];

#[test]
fn cjk_static_snapshots_match() {
    ...
    for name in SNAPSHOT_NAMES {
        let source_path = root
            .join("tests/snapshots/cjk/input")
            .join(format!("{name}.mmd"));
        let expected_path = root
            .join("tests/golden/kumeyuri-static/cjk")
