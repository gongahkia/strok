...
fn apply_packet_animation_directives(
    ...
    match statement {
        ...
        PacketStatement::Title(_) | PacketStatement::Field(_) | PacketStatement::Comment(_) => {}
    }
    Ok(())
}
...
fn apply_architecture_animation_directives(
    ...
    match statement {
        ...
        ArchitectureStatement::Group(_)
        | ArchitectureStatement::Service(_)
        | ArchitectureStatement::Junction(_)
        | ArchitectureStatement::Edge(_)
        | ArchitectureStatement::Alignment(_)
        | ArchitectureStatement::Comment(_) => {}
    }
    Ok(())
}
...
fn apply_event_modeling_animation_directives(
    ...
    match statement {
        ...
        EventModelingStatement::TimeFrame(_)
        | EventModelingStatement::DataBlock(_)
        | EventModelingStatement::Comment(_) => {}
    }
    Ok(())
}
