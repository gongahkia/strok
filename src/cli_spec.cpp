...
constexpr CliOptionSpec kCliOptionSpecs[] = {
  ...
  {"--input-open-timeout MS", "live-input open/probe timeout in milliseconds; 0 disables"},
  {"--read-timeout MS", "live-input read timeout in milliseconds; 0 disables"},
  {"--rtsp-transport {auto|tcp|udp}", "RTSP transport preference"},
  {"--reconnect", "reconnect live camera/RTSP input after failure (default)"},
  {"--no-reconnect", "stop after a live camera/RTSP input failure"},
  {"--reconnect-backoff MS", "initial live reconnect delay, capped exponentially"},
